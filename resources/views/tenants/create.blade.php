...
<div class="max-w-md mx-auto bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-8 shadow-xl space-y-6">
    <div class="text-center space-y-2">
        ...
        <h1 class="text-2xl font-extrabold text-slate-900">Izveidot Darbavietu</h1>
        <p class="text-xs text-slate-500">Pievieno jaunu komandas telpu vai projektu</p>
    </div>
    ...
    <form action="{{ route('tenants.store') }}" method="POST" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name') }}" required placeholder="Piem., Jaunuzņēmums X 🚀"
